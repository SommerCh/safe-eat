    ...
    <div className="bg-white pb-10">
      <header className="sticky top-0 bg-white/80 backdrop-blur-md border-b border-slate-100 px-4 py-4 flex items-center z-10">
        ...
        <h1 className="ml-2 font-bold text-slate-900 text-lg">
          {t("legal_header", "Vilkår & Privatliv")}
        </h1>
      </header>
      ...
      <main className="max-w-2xl mx-auto px-6 py-8 space-y-10">
        <section className="space-y-2">
          <p className="text-sm text-slate-400 font-medium uppercase tracking-wider">
            {t("legal_last_updated", "Sidst opdateret: 27. marts 2026")}
          </p>
          <h2 className="text-2xl font-extrabold text-slate-900 tracking-tight">
            {t("legal_main_title", "Gennemsigtighed")}{" "}
            <span className="text-[#F4642B]">&</span>{" "}
            {t("legal_main_title_2", "Sikkerhed")}
          </h2>
        ...
        <section className="p-6 bg-amber-50 border-2 border-[#F4642B] rounded-[2rem] space-y-4">
          <div className="flex items-center gap-2 text-[#F4642B]">
            ...
            <h3 className="font-bold text-[#F4642B] text-lg">
              {t("legal_disclaimer_title", "Vigtig Ansvarsfraskrivelse")}
            </h3>
          </div>
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-2 text-slate-900">
            <h3 className="text-xl text-[#F4642B] font-bold">
              {t("legal_subs_title", "Abonnement & Betaling")}
            </h3>
          </div>
            ...
            <div className="grid gap-4">
              <div className="space-y-1">
                <h4 className="font-bold text-slate-900">
                  {t("legal_subs_auto_title", "Automatisk fornyelse")}
                </h4>
                <p>
                  {t(
                    "legal_subs_auto_p",
              ...
              <div className="space-y-1">
                <h4 className="font-bold text-slate-900">
                  {t("legal_subs_cancel_title", "Opsigelse")}
                </h4>
                <p>
                  {t(
                    "legal_subs_cancel_p",
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-2 text-slate-900">
            <h3 className="text-xl text-[#F4642B] font-bold">
              {t("legal_privacy_title", "Privatlivspolitik (GDPR)")}
            </h3>
          </div>
          ...
          <div className="grid gap-6">
            <div className="space-y-2">
              <h4 className="font-bold text-slate-900 flex items-center gap-2">
                {t("legal_privacy_account_title", "Brugerkonto & Login")}
              </h4>
              <p className="text-sm text-slate-600 leading-relaxed ml-3.5">
                {t(
                  "legal_privacy_account_p",
            ...
            <div className="space-y-2">
              <h4 className="font-bold text-slate-900 flex items-center gap-2">
                {t("legal_privacy_health_title", "Helbredsdata (Allergier)")}
              </h4>
              <p className="text-sm text-slate-600 leading-relaxed ml-3.5">
                {t(
                  "legal_privacy_health_p",
            ...
            <div className="space-y-2">
              <h4 className="font-bold text-slate-900 flex items-center gap-2">
                {t("legal_privacy_images_title", "Billedbehandling")}
              </h4>
              <p className="text-sm text-slate-600 leading-relaxed ml-3.5">
                {t(
                  "legal_privacy_images_p",
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-2 text-slate-900">
            <h3 className="text-xl text-[#F4642B] font-bold">
              {t("legal_rights_title", "Dine Rettigheder")}
            </h3>
          </div>
